  ...
  <!--
      ...
      <div class="main__contentinfo">
        ...
        <h3>Заповніть профіль клієнта</h3>

        <div>
          <form method="POST" action="{{route('new_client')}}" enctype="multipart/form-data">
          {{csrf_field()}}
            ...
            <input style="margin-bottom: 10px;" type="date" id="age" name="birthday">

            <label for="email">Электронна адреса</label>
            <input style="margin-bottom: 10px;" type="email" id="email" name="email">
            ...
            <input style="margin-bottom: 10px;" type="date" id="accepted" name="accepted">

            <label for="quit">Покинуто</label>
