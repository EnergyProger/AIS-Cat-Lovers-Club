  ...
  <!--
      ...
      <div class="main__contentinfo">
        ...
        @foreach($employee as $u)
          <form method="POST" action="{{route('update_employee',$u->email_admin)}}" enctype="multipart/form-data">
          {{csrf_field()}}
            ...
            <input style="margin-bottom: 10px;" type="date" id="accept" name="accept" value="{{$u->accept}}">
